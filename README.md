...
|類別|危険等級|品名|引火点|指定数量|備考|
|:--|:--|:--|:--|:--|:--|
|特殊引火物|Ⅰ|ジエチルエーテル<br>二硫化水素|~ -20℃|50L||
|第1種石油類|Ⅱ|ガソリン<br>トルエン<br><アセトン>|~ +21℃|200L<br><400L>||
|アルコール類|Ⅱ|メタノール エタノール||400L||
|第2種石油類|Ⅲ|灯油 経由<br><酢酸>|+21℃ ~ +70℃|1,000L<br><2,000L>||
|第3種石油類|Ⅲ|重油 クレオソート油<br><グリセリン>|+70℃ ~ +200℃|2,000L<br><4,000L>||
|第4種石油類|Ⅲ|ギヤー油 シリンダー油|+200℃ ~ +250℃|6,000L||
|動植物油類|Ⅲ|ギヤー油 シリンダー油|~ +250℃|10,000L||

### 危険物施設

#### 施設の分類・制限など

|類別|予防規定|保安距離|保有空地|定期点検|取扱物制限|容量制限|危険物保安監督者|危険物保安統括責任者|危険物施設保安院|
|:--|:--|:--|:--|:--|:--|:--|:--|:--|:--|
|製造所|要 (指定数量以上)|要|要|要|-|-|要|要<br>(指定数量の倍数3000以上)|要|
|屋内貯蔵所|要 (指定数量以上)|要|要|要|-|-|要|-|-|
|屋外貯蔵所|要 (指定数量以上)|要|要|-|第4類NG物 : 特殊引火物・引火点0℃未満の第1種石油類|-|要|-|-|
|屋内タンク貯蔵所|-|-|-|-|-|指定数量の40倍以下<br>第4主石油類・動植物油以外の第4類危険物は20,000L以下|要|-|-|
|屋外タンク貯蔵所|要 (指定数量以上)|要|要|要|-|-|要|-|-|
|地下タンク貯蔵所|-|-|-|要|-|-|要|-|-|
|移動タンク貯蔵所|-|-|-|要|-|30,000L以下|-|-|-|
|簡易タンク貯蔵所|-|-|要|-|-|600L以下<br>タンク3基以内|要|-|-|
|給油取扱所|要|-|-|要|-|-|要|-|-|
|販売取扱所|-|-|-|-|-|第1種販売取扱所 : 指定数量15倍以下<br>第2種販売取扱所 : 指定数量15~40倍|要|-|-|
|移送取扱所|要|-|-|要|-|-|要|要<br>(指定数量以上)|要|
|一般取扱所|要 (指定数量以上)|要|要|要|-|-|要|要<br>(指定数量の倍数3000以上)|要|
